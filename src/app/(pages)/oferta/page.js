...
import { BsSend, BsArrowUpShort } from "react-icons/bs"
...
function Card({...props}){
    return(
        ...
        <div className="lg:w-96 bg-slate-600/30 rounded-xl min-w-fit flex flex-col overflow-hidden shadow-md shadow-black/20">
