...
export default function QuickContact(){
    ...
    return(
        <div className="bg-gradient-to-br from-sky-500 to-emerald-200 rounded-xl w-fit sm:p-5 p-3 text-base
            ...
            <div className="flex gap-2">
                <p className={`${folded ? "w-0" : "w-72 max-sm:w-44"} overflow-hidden transition-all ease-in flex max-sm:flex-col`}><p>Skontaktuj się z nami:</p> <Link href={"tel:+48 509 012 407"} className="cursor-pointer">+48 509 012 407</Link></p>
