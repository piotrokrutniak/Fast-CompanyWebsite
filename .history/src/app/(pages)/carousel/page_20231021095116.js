...
export default function CarouselPage(){
    return(
        <div className="max-w-7xl mx-auto absolute flex overflow-x-auto">
            <div className="flex gap-5 h-128 relative w-full overflow-x-auto">
                <Image src={p1} layout='fill' objectFit='cover' className="w-full"/>
            </div>
            <div className="flex flex-row gap-5 h-128 relative w-full overflow-x-auto">
