    ...
    return(
        <main className="min-h-screen">
            <section id="oferty" className="m-auto">
                <div className="sm:p-16 max-w-7xl m-auto p-7">
                    <h1 className="mb-5 pb-2 text-4xl lg:text-5xl font-semibold"> Nasza oferta </h1>
                    <p className="text-base sm:text-lg opacity-80 font-normal leading-relaxed"> Specjalizujemy się w montażu klimatyzacji, pomp ciepła i ogrzewania centralnego. Oferujemy nie tylko wysokiej jakości instalacje, ale także fachowe doradztwo, projektowanie i serwis. Niezależnie od tego, czy potrzebujesz klimatyzacji do domu, biura czy hali produkcyjnej, zapewniamy Ci optymalne rozwiązania, które zapewnią Ci komfort termiczny i niskie rachunki za energię.</p>
                ...
                <div className="bg-slate-600/10 lg:py-28 px-5 p-2 py-10">
            ...
            <section id="informacje" className="max-w-7xl m-auto lg:py-16 flex flex-col gap-8">
