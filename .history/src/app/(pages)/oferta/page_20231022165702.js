        ...
        <main className="min-h-screen">
            <section id="oferty" className="m-auto">
                <div className="sm:p-16 max-w-7xl m-auto p-5">
                    ...
                    <p className="text-base sm:text-lg opacity-80 font-normal leading-relaxed"> Jeśli szukasz profesjonalnej i rzetelnej firmy zajmującej się montażem klimatyzacji, pomp ciepła i ogrzewania centralnego, to dobrze trafiłeś. Nasza firma oferuje kompleksowe usługi w zakresie projektowania, instalacji i serwisu systemów chłodniczych i grzewczych dla domów, biur i obiektów przemysłowych. Zaufaj naszemu doświadczeniu i wiedzy, a zapewnimy Ci komfort i oszczędność energii przez cały rok.</p>
                    <p className="text-base sm:text-lg opacity-80 leading-relaxed font-semibold pt-2">Jesteśmy ulokowani w województwie małopolskim, pod Wieliczką, ale świadczymy usługi na terenie całego kraju.</p>
                </div>
