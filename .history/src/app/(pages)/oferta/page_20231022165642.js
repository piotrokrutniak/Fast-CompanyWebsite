        ...
        <main className="min-h-screen">
            <section id="oferty" className="m-auto">
                <div className="sm:p-16 max-w-7xl m-auto p-5">
                    ...
                    <p className="text-base sm:text-lg opacity-80 !leading-9 font-semibold">Jesteśmy ulokowani w województwie małopolskim, pod Wieliczką, ale świadczymy usługi na terenie całego kraju.</p>
                </div>
