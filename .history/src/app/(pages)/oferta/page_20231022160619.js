            ...
            <section id="oferty" className="m-auto">
                ...
                <div className="bg-slate-600/10 lg:py-28 p-2 py-10">
                    <div className="w-fit grid lg:grid-cols-2 2xl:grid-cols-3 max-w-7xl m-auto gap-10 lg:gap-10 items-stretch">
                        <Card scrollTo="#klimatyzacja" image={img1} title="Klimatyzacje" desc="Zapewniają optymalną temperaturę i wilgotność powietrza, poprawiają jakość powietrza i komfort termiczny. Oferujemy klimatyzatory typu split, multi-split, kanałowe, kasetonowe, ścienne, podłogowe i sufitowe."/>
