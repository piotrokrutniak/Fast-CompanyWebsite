        ...
        <main className="min-h-screen">
            <section id="oferty" className="m-auto">
                <div className="sm:p-16 max-w-7xl m-auto p-5">
                    <h1 className="mb-5 pb-2 text-4xl lg:text-5xl font-semibold"> Nasza oferta </h1>
                    <p className="text-base sm:text-lg opacity-80 font-normal leading-relaxed"> Specjalizujemy się w montażu klimatyzacji, pomp ciepła i ogrzewania centralnego. Oferujemy nie tylko wysokiej jakości instalacje, ale także fachowe doradztwo, projektowanie i serwis. Niezależnie od tego, czy potrzebujesz klimatyzacji do domu, biura czy hali produkcyjnej, dostarczymy Ci optymalne rozwiązania, które zapewnią Ci komfort termiczny i niskie rachunki za energię.</p>
                    <p className="text-base sm:text-lg opacity-80 leading-relaxed font-semibold pt-4">Nasza siedziba znajduje się w Niepołomicach, niedaleko Krakowa, ale działamy na terenie całej Polski.</p>
                </div>
            ...
            <section id="informacje" className="max-w-7xl m-auto lg:py-16 flex sm:px-5 flex-col gap-8">
        ...
        <div className="lg:w-96 bg-slate-600/30 hover:bg-slate-600/50 rounded-xl min-w-fit flex flex-col overflow-hidden shadow-md lg:hover:-translate-y-4 shadow-black/20 transition-all">
            <Link href={props.scrollTo}>
                <div className="lg:h-64 h-screen-1/2 w-full bg-black/20 relative cursor-pointer">
                    <Image src={props.image} alt={props.title} layout='fill' objectFit='cover' className='z-0 opacity-80'/>
                </div>
            </Link>
