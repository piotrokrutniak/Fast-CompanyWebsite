        ...
        <main className="min-h-screen">
            <section id="oferty" className="m-auto">
                <div className="sm:p-16 max-w-7xl m-auto p-5">
                    ...
                    <h3 className="text-lg sm:text-xl font-normal leading-relaxed"> Jeśli szukasz profesjonalnej i rzetelnej firmy zajmującej się montażem klimatyzacji, pomp ciepła i ogrzewania centralnego, to dobrze trafiłeś. Nasza firma oferuje kompleksowe usługi w zakresie projektowania, instalacji i serwisu systemów chłodniczych i grzewczych dla domów, biur i obiektów przemysłowych. Zaufaj naszemu doświadczeniu i wiedzy, a zapewnimy Ci komfort i oszczędność energii przez cały rok.</h3>
                </div>
