            ...
            <section id="oferty" className="m-auto">
                ...
                <div className="bg-slate-600/10 lg:py-28 p-2 py-10">
                    <div className="w-fit grid lg:grid-cols-2 2xl:grid-cols-3 max-w-7xl m-auto gap-10 lg:gap-10 items-stretch">
                        ...
                        <Card scrollTo="#ogrzewanie" image={img3} title="Instalacje grzewcze" desc="Zapewniają odpowiednie ogrzewanie pomieszczeń i wody użytkowej. Instalacje grzewcze są bezpieczne, wydajne i komfortowe. Pozwalają na regulację temperatury według indywidualnych preferencji."/>
                    </div>
                </div>
            </section>
