    ...
    return(
        <main className="min-h-screen">
            <section id="oferty" className="m-auto">
                ...
                <div className="bg-slate-600/10 sm:py-28 p-2 py-10">
...
function Card({...props}){
    return(
        ...
        <div className="lg:w-96 bg-slate-600/30 hover:bg-slate-600/50 rounded-xl min-w-fit flex flex-col overflow-hidden shadow-md md:hover:-translate-y-4 shadow-black/20 transition-all">
            <Link href={props.scrollTo}>
                <div className="h-64 w-full bg-black/20 relative cursor-pointer">
