...
function Card({...props}){
    return(
        ...
        <div className="lg:w-96 bg-slate-600/30 hover:bg-slate-600/40 rounded-xl min-w-fit flex flex-col overflow-hidden shadow-md hover:-translate-y-4 shadow-black/20 transition-all">
