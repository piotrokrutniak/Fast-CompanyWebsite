        ...
        <main className="min-h-screen">
            <section id="oferty" className="m-auto">
                <div className="sm:p-16 max-w-7xl m-auto p-5">
                    <h1 className="mb-5 pb-5 text-4xl lg:text-5xl font-semibold border-b-2 border-slate-600/30"> Nasza oferta </h1>
            ...
            <section id="informacje" className="max-w-7xl m-auto lg:p-16 flex flex-col gap-8">
