...
export default function Kontakt(){
    return(
        <main className="min-h-screen scroll-smooth">
            <section id="kontakt" className="max-w-7xl m-auto h-screen flex place-items-center lg:pb-10">
            <div className="z-10 w-full items-center justify-between text-sm lg:flex max-xs:p-5">
