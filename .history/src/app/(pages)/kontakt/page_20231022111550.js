...
export default function Kontakt(){
    return(
        <main className="min-h-screen scroll-smooth">
            <section id="kontakt" className="max-w-7xl m-auto">
            <div className="z-10 w-full items-center justify-between text-sm lg:flex p-10 max-xs:p-5">
            <div className='max-w-7xl flex gap-20 sm:py-20 h-full mx-auto max-lg:flex-col-reverse max-lg:gap-10 re'>
            ...
            <div className='relative self-center w-full'>
                ...
                <ul>
                    ...
                    <li className="p-4">
                        ...
                        <h3 className='text-xl font-thin leading-9 max-sm:text-lg w-fit'> 
                            <Link href={"mailto:fast@firma.pl"} className="cursor-pointer hover:text-emerald-200">
                                <p className="whitespace-nowrap w-fit">
                                    fast@firma.pl
                                </p>
                            </Link> 
