    ...
    return(
        <main className="min-h-screen scroll-smooth">
            <section id="Realizacje" className="max-w-7xl m-auto flex flex-col gap-5">
                ...
                {loading ? <div className="p-8 font-semibold flex gap-2 mx-auto lg:text-2xl opacity-80 animate-pulse">Ładowanie postów <BsArrowClockwise className="animate-spin h-6 w-6"/> </div> :
                posts?.length == 0 ?
