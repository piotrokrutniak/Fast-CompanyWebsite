        ...
        <main className="min-h-screen scroll-smooth">
            <section id="Realizacje" className="max-w-7xl m-auto flex flex-col gap-5">
                <div className="p-6 lg:p-16">
                    <h1 className="text-3xl sm:text-5xl font-semibold border-slate-600/30 pb-4">Realizacje</h1>
                    <p className="text-base sm:text-lg opacity-80 font-normal leading-relaxed">XD</p>
                </div>
                ...
                <div className="w-full p-6 bg-slate-800/10 flex justify-center rounded-lg gap-2">
