  ...
  return (
    ...
    <main className="min-h-screen">
      <div className="z-10 w-full items-center justify-between text-sm lg:flex p-10 max-xs:p-5">
        <div className='max-w-7xl m-auto flex gap-20 py-10 sm:py-32 align-middle h-full max-lg:flex-col-reverse flex-row-reverse max-lg:gap-10'>
      ...
      <div className="z-10 w-full items-center justify-between text-sm lg:flex p-10 max-xs:p-5">
        <div className='max-w-7xl m-auto flex gap-20 py-10 sm:py-32 align-middle h-full max-lg:flex-col-reverse max-lg:gap-10'>
          <div className='w-96 h-96 shrink-0 bg-slate-500 rounded-xl relative self-center max-lg:w-full overflow-clip'>
      ...
      <div className="z-10 w-full items-center justify-between text-sm lg:flex p-10 max-xs:p-5">
        <div className='max-w-7xl m-auto flex gap-20 py-10 sm:py-32 align-middle h-full max-lg:flex-col max-lg:gap-10'>
          <div className='relative self-center'>
