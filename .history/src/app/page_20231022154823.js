...
export default function Home() {
  ...
  return (
    ...
    <main className="min-h-screen flex flex-col gap-2 pt-10 md:gap-16">
      <div className="z-10 w-full items-center justify-between text-sm lg:flex p-10 max-xs:p-5">
        <div className='max-w-7xl m-auto flex gap-20 py-10 align-middle h-full max-lg:flex-col-reverse flex-row-reverse max-lg:gap-10'>
      ...
      <div className="z-10 w-full items-center justify-between text-sm lg:flex p-10 max-xs:p-5">
        <div className='max-w-7xl m-auto flex gap-20 py-10 align-middle h-full max-lg:flex-col-reverse max-lg:gap-10'>
          ...
          <div className='relative self-center'>
            ...
            <h2 className='text-xl font-thin leading-9 max-sm:text-lg'>Nasza firma ma swoją siedzibę w województwie małopolskim, ale świadczy usługi na terenie całego kraju. Niezależnie od tego, gdzie się znajdujesz, możesz liczyć na naszą szybką i sprawną realizację zlecenia. Jesteśmy mobilni i elastyczni, a nasze doświadczenie pozwala nam sprostać każdemu wyzwaniu. Nie zwlekaj i zamów nasze usługi już dziś.</h2>
          </div>
        </div>
      </div>
      <div className="z-10 w-full items-center justify-between text-sm lg:flex p-10 max-xs:p-5">
        <div className='max-w-7xl m-auto flex gap-20 py-10 align-middle h-full max-lg:flex-col max-lg:gap-10'>
          <div className='relative self-center'>
            ...
            <div className='grid grid-cols-2 gap-5 self-center'>
              <Link href="https://www.firmagodnazaufania.pl/about" target="_blank">
                <div className='w-48 h-48 shrink-0 bg-white rounded-xl relative items-center justify-center flex cursor-pointer max-sm:w-36 max-sm:h-36 p-4'>
                  <Image src={award2015} alt="Firma Godna Zaufania 2015" className='text-black hover:scale-105 transition-all' width={120} height={120}/>
                </div>
              </Link>
              <Link href="https://www.firmagodnazaufania.pl/about" target="_blank">
                <div className='w-48 h-48 shrink-0 bg-white rounded-xl relative items-center justify-center flex cursor-pointer max-sm:w-36 max-sm:h-36 p-4'>
                  <Image src={award2016} alt="Firma Godna Zaufania 2015" className='text-black hover:scale-105 active:scale-95 transition-all' width={120} height={120}/>
                </div>
              </Link>
              <Link href="https://www.firmagodnazaufania.pl/about" target="_blank">
                <div className='w-48 h-48 shrink-0 bg-white rounded-xl relative items-center justify-center flex cursor-pointer max-sm:w-36 max-sm:h-36 p-4'>
                  <Image src={award2017} alt="Firma Godna Zaufania 2015" className='text-black hover:scale-105 transition-all' width={120} height={120}/>
                </div>
              </Link>
              <Link href="http://www.polskiorzelbiznesu.pl/" target="_blank">
                <div className='w-48 h-48 shrink-0 bg-white rounded-xl relative items-center justify-center flex cursor-pointer max-sm:w-36 max-sm:h-36 p-4'>
                  <Image src={award2016orzel} alt="Firma Godna Zaufania 2015" className='text-black hover:scale-105 transition-all' width={170} height={120}/>
                </div>
              </Link>
            </div>
          </div>
