...
export default function CarouselBase({ slides, alt }) {
    ...
    return(
        <div className='w-full m-auto min-w-mobile h-full max-w-7xl'> 
            <div className='w-full min-w-mobile m-auto h-full max-w-7xl items-center flex group transition-all bg-black/30 relative' >
                ...
                <div className='bg-black/10 p-2 rounded-2xl sm:hidden group-hover:block hover:bg-black/20 active:scale-95'>
                    <BsChevronCompactLeft color='white' className='w-10 z-10 h-10 cursor-pointer opacity-0 group-hover:opacity-60 hover:opacity-100 
