...
export default function BlogPost({...props}){
    ...
    return(
        <section id={props.id} className="w-full items-center justify-between text-sm lg:flex p-5 lg:p-10 bg-slate-800/10 lg:rounded-lg shadow-lg">
            ...
            {fullScreen && 
            <div className="fixed top-0 left-0 w-screen h-screen bg-black/40 backdrop-blur-sm z-50 p-12">
                <BsX className="absolute w-16 h-16 top-4 right-4 cursor-pointer hover:fill-red-600 active:opacity-70 transition-opacity" onClick={() => setFullScreen(false)}/>
