    ...
    return(
        ...
        <div className={`${className} w-full m-auto h-full max-w-7xl`}> 
            <div className='w-full m-auto h-full max-w-7xl items-center flex group transition-all bg-black/30 relative' >
                ...
                <div className='flex w-full justify-between relative p-2 -z-10'>
                ...
                <div className='bg-black/10 p-2 z-10 rounded-2xl sm:hidden group-hover:block hover:bg-black/20 active:scale-95 z-20'>
