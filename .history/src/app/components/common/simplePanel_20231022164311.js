...
export default function SimplePanel({...props}){
    return(
        <section id={props.id} className="z-10 w-full items-center justify-between text-sm lg:flex p-5 md:p-10 max-xs:p-5">
            <div className='max-w-7xl m-auto flex gap-20 py-10 align-middle h-full max-md:flex-col-reverse max-lg:gap-10'>
